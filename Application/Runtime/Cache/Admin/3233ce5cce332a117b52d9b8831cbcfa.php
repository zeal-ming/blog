...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <form action='/blog/index.php/Admin/Article/sort' method="post">
                    ...
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($Articles)): $i = 0; $__LIST__ = $Articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                ...
                                <a class="link-del" href="/blog/index.php/Admin/Article/del/id/<?php echo ($vo["id"]); ?>" onsubmit="return confirm('确认删除？')">删除</a>
                            </td>
