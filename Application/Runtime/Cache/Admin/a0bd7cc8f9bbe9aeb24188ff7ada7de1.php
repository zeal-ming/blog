                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="name" size="50" type="text" value="<?php echo ($category["name"]); ?>">
                                    <input value="<?php echo ($category["id"]); ?>" name='id' type="hidden"/>
                                </td>
                            </tr>
