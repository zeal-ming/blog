                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                               ...
                               <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="username" size="50" type="text" value="<?php echo ($Admin["username"]); ?>">
                               ...
                               <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="password" size="50" type="text" value="<?php echo ($Admin["password"]); ?>">
                                </td>
                            </tr>
